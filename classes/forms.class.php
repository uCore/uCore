...
//		timer_end('LoadChildren 1 '.get_class($this)."->_ParentLoad($parent)");
	...
	public function _RunModule() {
		...
		if (flag_is_set($this->GetOptions(),IS_ADMIN) && FlexDB::UsingTemplate(DEFAULT_TEMPLATE))
			FlexDB::UseTemplate(TEMPLATE_ADMIN);
